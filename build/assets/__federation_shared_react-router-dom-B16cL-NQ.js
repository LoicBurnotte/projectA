...
var AwaitContextProvider = (props) => React$2.createElement(AwaitContext.Provider, props);
...
function useNavigationType() {
  return React2$2.useContext(LocationContext).navigationType;
}
...
function useOutletContext() {
  return React2$2.useContext(OutletContext);
}
function useOutlet(context) {
  let outlet = React2$2.useContext(RouteContext).outlet;
  return React2$2.useMemo(
    () => outlet && /* @__PURE__ */ React2$2.createElement(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
var RenderErrorBoundary = class extends React2$2.Component {
  ...
  render() {
    ...
    let result = error !== void 0 ? /* @__PURE__ */ React2$2.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ React2$2.createElement(
    ...
    if (this.context) {
      return /* @__PURE__ */ React2$2.createElement(RSCErrorHandler, { error }, result);
    }
    return result;
  }
};
...
function RSCErrorHandler({
  ...
  let { basename } = React2$2.useContext(NavigationContext);
...
function useRevalidator() {
  ...
  let revalidate = React2$2.useCallback(async () => {
...
function useAsyncValue() {
  let value = React2$2.useContext(AwaitContext);
  return value?._data;
}
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = React2$2.useState("");
  let blockerFunction = React2$2.useCallback(
    (arg) => {
...
const React3$1 = await importShared('react');
...
var useOptimisticImpl = React3$1[USE_OPTIMISTIC];
...
function mapRouteProperties(route) {
  ...
  if (route.Component) {
    ...
    Object.assign(updates, {
      element: React3$1.createElement(route.Component),
      Component: void 0
    });
  }
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: React3$1.createElement(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: React3$1.createElement(route.ErrorBoundary),
...
function RouterProvider({
  ...
  let [_state, setStateImpl] = React3$1.useState(router.state);
  let [state, setOptimisticState] = useOptimisticSafe(_state);
  let [pendingState, setPendingState] = React3$1.useState();
  let [vtContext, setVtContext] = React3$1.useState({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = React3$1.useState();
  let [transition, setTransition] = React3$1.useState();
  let [interruption, setInterruption] = React3$1.useState();
  let fetcherData = React3$1.useRef(/* @__PURE__ */ new Map());
  let setState = React3$1.useCallback(
  ...
  React3$1.useLayoutEffect(() => router.subscribe(setState), [router, setState]);
  React3$1.useEffect(() => {
  ...
  let navigator = React3$1.useMemo(() => {
    return {
  ...
  let dataRouterContext = React3$1.useMemo(
    () => ({
      router,
      navigator,
      static: false,
  ...
  return /* @__PURE__ */ React3$1.createElement(React3$1.Fragment, null, /* @__PURE__ */ React3$1.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ React3$1.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ React3$1.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ React3$1.createElement(ViewTransitionContext.Provider, { value: vtContext }, /* @__PURE__ */ React3$1.createElement(
    Router,
    {
      basename,
      location: state.location,
    ...
    /* @__PURE__ */ React3$1.createElement(
      MemoizedDataRoutes,
      {
...
var MemoizedDataRoutes = React3$1.memo(DataRoutes);
function DataRoutes({
  routes,
  future,
  state,
...
function MemoryRouter({
  ...
  let historyRef = React3$1.useRef();
  ...
  let [state, setStateImpl] = React3$1.useState({
  ...
  let setState = React3$1.useCallback(
    (newState) => {
      if (unstable_useTransitions === false) {
        ...
        React3$1.startTransition(() => setStateImpl(newState));
      }
    },
    [unstable_useTransitions]
  );
  React3$1.useLayoutEffect(() => history.listen(setState), [history, setState]);
  return /* @__PURE__ */ React3$1.createElement(
    Router,
    {
      basename,
      children,
...
function Navigate({
  ...
  let { static: isStatic } = React3$1.useContext(NavigationContext);
  warning(
    !isStatic,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`
  );
  let { matches } = React3$1.useContext(RouteContext);
  let { pathname: locationPathname } = useLocation();
...
function Router({
  ...
  let navigationContext = React3$1.useMemo(
    () => ({
      basename,
      navigator,
      static: staticProp,
  ...
  let locationContext = React3$1.useMemo(() => {
  ...
  return /* @__PURE__ */ React3$1.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ React3$1.createElement(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location
...
function Await({
  ...
  let dataRouterContext = React3$1.useContext(DataRouterContext);
  let dataRouterStateContext = React3$1.useContext(DataRouterStateContext);
  let onError = React3$1.useCallback(
    (error, errorInfo) => {
  ...
  return /* @__PURE__ */ React3$1.createElement(
    ...
    /* @__PURE__ */ React3$1.createElement(ResolveAwait, null, children)
  );
}
var AwaitErrorBoundary = class extends React3$1.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) {
      return /* @__PURE__ */ React3$1.createElement(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1) {
      return /* @__PURE__ */ React3$1.createElement(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
function ResolveAwait({
  ...
  return /* @__PURE__ */ React3$1.createElement(React3$1.Fragment, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
  let routes = [];
  React3$1.Children.forEach(children, (element, index) => {
    if (!React3$1.isValidElement(element)) {
      return;
    }
    let treePath = [...parentPath, index];
    if (element.type === React3$1.Fragment) {
      routes.push.apply(
        routes,
...
function WithComponentProps({
  ...
  return React3$1.cloneElement(children, props);
}
function withComponentProps(Component4) {
  return function WithComponentProps2() {
    const props = useRouteComponentProps();
    return React3$1.createElement(Component4, props);
  };
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return React3$1.createElement(HydrateFallback, props);
  };
}
...
function withErrorBoundaryProps(ErrorBoundary) {
  return function WithErrorBoundaryProps2() {
    const props = useErrorBoundaryProps();
    return React3$1.createElement(ErrorBoundary, props);
  };
}
...
const React4$1 = await importShared('react');
...
function StreamTransfer({
  ...
  let scriptTag = value ? /* @__PURE__ */ React4$1.createElement(
    "script",
    {
      nonce,
  ...
  if (done) {
    return /* @__PURE__ */ React4$1.createElement(React4$1.Fragment, null, scriptTag, /* @__PURE__ */ React4$1.createElement(
      "script",
      {
        nonce,
        dangerouslySetInnerHTML: {
    ...
    return /* @__PURE__ */ React4$1.createElement(React4$1.Fragment, null, scriptTag, /* @__PURE__ */ React4$1.createElement(React4$1.Suspense, null, /* @__PURE__ */ React4$1.createElement(
      StreamTransfer,
      {
        context,
...
function RemixRootDefaultHydrateFallback() {
  return /* @__PURE__ */ React5.createElement(BoundaryShell, { title: "Loading...", renderScripts: true }, /* @__PURE__ */ React5.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
...
function ServerRouter({
  ...
  return /* @__PURE__ */ React$1.createElement(React$1.Fragment, null, /* @__PURE__ */ React$1.createElement(
    ...
    /* @__PURE__ */ React$1.createElement(RemixErrorBoundary, { location: router.state.location }, /* @__PURE__ */ React$1.createElement(
  ...
  ), context.serverHandoffStream ? /* @__PURE__ */ React$1.createElement(React$1.Suspense, null, /* @__PURE__ */ React$1.createElement(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
function createRoutesStub(routes, _context) {
  return function RoutesTestStub({
    ...
    let routerRef = React2$1.useRef();
    let frameworkContextRef = React2$1.useRef();
    ...
    return /* @__PURE__ */ React2$1.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ React2$1.createElement(RouterProvider, { router: routerRef.current }));
  };
}
